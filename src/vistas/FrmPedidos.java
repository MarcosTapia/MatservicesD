...
public class FrmPedidos extends javax.swing.JFrame {
    ...
    public FrmPedidos(List<DetallePedidoBean> detallePedidoProducto
        ...
        initComponents();
        JOptionPane.showMessageDialog(null, pedidoBean.getIdCliente());
        JOptionPane.showMessageDialog(null, detallePedidoProducto.size());
