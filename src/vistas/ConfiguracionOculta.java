...
public class ConfiguracionOculta extends javax.swing.JFrame {

    public ConfiguracionOculta() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfiguracionOculta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConfiguracionOculta().setVisible(true);
            }
        });
    }
