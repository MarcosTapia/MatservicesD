...
public class WSUsuariosList {
    String cadena;
    URL url = null; // Url de donde queremos obtener información
    String devuelve ="";

        public ArrayList<UsuarioBean> ejecutaWebService(String... params) {
            cadena = params[0];
            url = null; // Url de donde queremos obtener información
            devuelve ="";
            ArrayList<UsuarioBean> usuarios = new ArrayList();
            switch (params[1]) { 
                case "1" : usuarios = mostrarUsuariosWS(); break;
    ...
    public ArrayList<UsuarioBean> mostrarUsuariosWS() {
        ArrayList<UsuarioBean> usuarios = new ArrayList();
        try {
            url = new URL(cadena);
