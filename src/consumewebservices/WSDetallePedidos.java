...
public class WSDetallePedidos {
    ...
    public DetallePedidoBean ejecutaWebService(String... params) {
        cadena = params[0];
        url = null; // Url de donde queremos obtener información
        DetallePedidoBean detallePedidoObj = null;
        switch (params[1]) { 
            case "1" : 
                idPedido = params[2];
                idArticulo = params[3];
            ...
            case "2" : 
                idPedido = params[2];
                detallePedidoObj = eliminaDetallePedidoWS(); break;
        }
...
//    }
    ...
    public DetallePedidoBean guardaDetallePedidoWS(String... params) {
        DetallePedidoBean inserta = null;
        try {
...
//    }
    ...
    public DetallePedidoBean eliminaDetallePedidoWS(String... params) {
        DetallePedidoBean elimina = null;
        try {
            HttpURLConnection urlConn;
            DataOutputStream printout;
            DataInputStream input;
