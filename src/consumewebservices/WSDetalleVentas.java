...
public class WSDetalleVentas {
    ...
    public DetalleVentaBean ejecutaWebService(String... params) {
        ...
        switch (params[1]) { 
            ...
            case "2" : 
                idVenta = params[2];
                detalleVentaObj = eliminaDetalleVentaWS(); break;
        }
...
//    }
    ...
    public DetalleVentaBean eliminaDetalleVentaWS(String... params) {
        DetalleVentaBean elimina = null;
        try {
            HttpURLConnection urlConn;
            DataOutputStream printout;
            DataInputStream input;
