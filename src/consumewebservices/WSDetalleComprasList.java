...
public class WSDetalleComprasList {
    String cadena;
    URL url = null; // Url de donde queremos obtener información
    String devuelve ="";

        public ArrayList<DetalleCompraBean> ejecutaWebService(String... params) {
            cadena = params[0];
            url = null; // Url de donde queremos obtener información
            devuelve ="";
            ArrayList<DetalleCompraBean> detalleCompras = new ArrayList();
            switch (params[1]) { 
                case "1" : detalleCompras = obtenerDetalleComprasWS(); break;
            }
...
//        }
    ...
    public ArrayList<DetalleCompraBean> obtenerDetalleComprasWS() {
        ArrayList<DetalleCompraBean> detalleCompras = new ArrayList();
        try {
            url = new URL(cadena);
            ...
            if (respuesta == HttpURLConnection.HTTP_OK){
                ...
                if (resultJSON == 1) {
                    JSONArray detalleComprasJSON = respuestaJSON.getJSONArray("detalleCompras");   // estado es el nombre del campo en el JSON
                    for(int i=0;i<detalleComprasJSON.length();i++){
                        DetalleCompraBean detalleCompra = new DetalleCompraBean();
                        detalleCompra.setIdDetalleCompra(detalleComprasJSON.getJSONObject(i).getInt("idDetalleCompra"));
                        detalleCompra.setIdCompra(detalleComprasJSON.getJSONObject(i).getInt("idCompra"));
                        detalleCompra.setIdArticulo(detalleComprasJSON.getJSONObject(i).getInt("idArticulo"));
                        detalleCompra.setPrecioPublico(detalleComprasJSON.getJSONObject(i).getDouble("precioPublico"));
                        detalleCompra.setPrecioCosto(detalleComprasJSON.getJSONObject(i).getDouble("precioCosto"));
