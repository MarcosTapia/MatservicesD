...
public abstract class NumberToLetterConverter {
    ...
    public static String convertNumberToLetter(double doubleNumber)
        ...
        String decimalesOriginales = splitNumber[1];
        if (decimalesOriginales.length()==1) {
            decimalesOriginales = decimalesOriginales + "0";
        } else {
            if (decimalesOriginales.length()>2) {
                decimalesOriginales = decimalesOriginales.substring(0,2);                    
            }            
        }
//        JOptionPane.showMessageDialog(null, decimalesOriginales);
        converted.append(" " + decimalesOriginales + "/100 M.N.");
